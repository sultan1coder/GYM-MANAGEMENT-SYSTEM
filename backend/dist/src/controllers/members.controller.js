...
exports.changeMemberPassword = exports.updateMemberBasicProfile = exports.getMemberStats = exports.bulkImportMembers = exports.uploadMemberProfilePicture = exports.updateMemberProfilePicture = exports.deleteMember = exports.updateMember = exports.loginMember = exports.registerMember = exports.getSingleMember = exports.searchMembers = exports.getAllMembers = void 0;
...
const uploadMemberProfilePicture = async (req, res) => {
    try {
        const memberId = req.params.id;
        if (!req.file) {
            res.status(400).json({
...
exports.uploadMemberProfilePicture = uploadMemberProfilePicture;
    ...
    try {
        ...
        const stats = {
            ...
            membershipDistribution: membershipDistribution.map((item) => ({
                ...
                percentage: (((item._count?.membershiptype || 0) / totalMembers) *
                    100).toFixed(1),
            })),
            ageDistribution: {
...
const updateMemberBasicProfile = async (req, res) => {
    try {
        const memberId = req.params.id;
        const { name, email, phone_number, age, membershiptype } = req.body;
        if (!name || !email) {
        ...
        if (email !== existingMember.email) {
            const emailExists = await prisma_1.default.member.findUnique({
                where: { email },
            });
            if (emailExists) {
                res.status(400).json({
...
exports.updateMemberBasicProfile = updateMemberBasicProfile;
const changeMemberPassword = async (req, res) => {
    try {
        ...
        const isCurrentPasswordValid = await (0, auth_1.comparePassword)(currentPassword, member.password);
