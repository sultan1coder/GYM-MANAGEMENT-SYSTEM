...
export declare const updateUserBasicProfile: (req: Request, res: Response) => Promise<void>;
export declare const changeUserPassword: (req: Request, res: Response) => Promise<void>;
export declare const enableTwoFactorAuth: (req: Request, res: Response) => Promise<void>;
export declare const disableTwoFactorAuth: (req: Request, res: Response) => Promise<void>;
export declare const verifyTwoFactorAuth: (req: Request, res: Response) => Promise<void>;
